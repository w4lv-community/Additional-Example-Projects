...
<Library LVVersion="17008000">
	...
	<Item Name="Worker Base Class" Type="Folder">
		<Item Name="Worker Base Class.lvclass" Type="LVClass" URL="../Workers/Base Classes/Worker Base Class/Worker Base Class.lvclass"/>
	</Item>
	<Item Name="Head Worker.lvclass" Type="LVClass" URL="../Workers/Head Worker/Head Worker.lvclass"/>
	<Item Name="First Level Worker.lvclass" Type="LVClass" URL="../Workers/First Level Worker/First Level Worker.lvclass"/>
	<Item Name="Second Level Worker.lvclass" Type="LVClass" URL="../Workers/Second Level Worker/Second Level Worker.lvclass"/>
	<Item Name="Launcher - Head Worker (method 3).vi" Type="VI" URL="../Launchers/Launcher - Head Worker (method 3).vi"/>
</Library>
